...
class VcfDedupTests(unittest.TestCase):
    ...
    def test1_0(self):
        ...
        self.vcf_transformer = StrelkaVcfDedupper(self.input_vcf, self.output_vcf, VariantComparerNoAlternate())
    ...
    def test2(self):
        ...
        self.vcf_transformer = StrelkaVcfDedupper(self.input_vcf, self.output_vcf, VariantComparerWithAlternate())
        self.vcf_transformer.process_vcf()
