...
class VcfDedupTests(unittest.TestCase):
    ...
    def test1_0(self):
        ...
        self.vcf_transformer = StrelkaVcfDedupper(self.input_vcf, self.output_vcf, VariantComparerNoAlternate(), 0)
    ...
    def test1_1(self):
        ...
        self.vcf_transformer = StarlingVcfDedupper(self.input_vcf, self.output_vcf, VariantComparerNoAlternate())
        self.vcf_transformer.process_vcf()

    def test2(self):
        self.input_vcf = "../resources/LP2000906-DNA_F01.somatic.atomic.left.split.vcf.gz"
        self.output_vcf = "../resources/test2_0.vcf"
        self.vcf_transformer = StrelkaVcfDedupper(self.input_vcf, self.output_vcf, VariantComparerWithAlternate(), 1)
        self.vcf_transformer.process_vcf()
